class AudiosController < AppController
  ...
  def update
    respond_to do |format|
      if @audio.update(audio_params)
        format.html { redirect_to @audio, notice: "Audio was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to audios_path, notice: "Audio was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_audio
      @audio = Audio.find(params.expect(:id))
    end
